...
from .views import RetriveCourse,CreateUserEnrollment,ListUserEnrollment,ProgressEnrollmentUpdateApiView

urlpatterns = [
    path('courses/<slug:slug>/',RetriveCourse.as_view(),name = 'courses'),
